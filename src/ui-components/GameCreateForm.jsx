...
export default function GameCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setOpponentID(initialValues.opponentID);
    setTurn(initialValues.turn);
    setResult(initialValues.result);
    setHostName(initialValues.hostName);
    setOpponentName(initialValues.opponentName);
    setHostColor(initialValues.hostColor);
    setOpponentColor(initialValues.opponentColor);
